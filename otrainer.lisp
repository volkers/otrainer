        ...
        (cond
          ((char= (elt pos i) #\r) (setf (nodgui:image (svref board i))
                                         (if (whitep row column)
                                             (nodgui:make-image "png/Chess_rdt60_white.gif")
                                             (nodgui:make-image "png/Chess_rdt60.gif"))))
          ((char= (elt pos i) #\n) (setf (nodgui:image (svref board i))
                                         (if (whitep row column)
                                             (nodgui:make-image "png/Chess_ndt60_white.gif")
                                             (nodgui:make-image "png/Chess_ndt60.gif"))))
          ((char= (elt pos i) #\b) (setf (nodgui:image (svref board i))
                                         (if (whitep row column)
                                             (nodgui:make-image "png/Chess_bdt60_white.gif")
                                             (nodgui:make-image "png/Chess_bdt60.gif"))))
          ((char= (elt pos i) #\q) (setf (nodgui:image (svref board i))
                                         (if (whitep row column)
                                             (nodgui:make-image "png/Chess_qdt60_white.gif")
                                             (nodgui:make-image "png/Chess_qdt60.gif"))))
          ((char= (elt pos i) #\k) (setf (nodgui:image (svref board i))
                                         (if (whitep row column)
                                             (nodgui:make-image "png/Chess_kdt60_white.gif")
                                             (nodgui:make-image "png/Chess_kdt60.gif"))))
          ((char= (elt pos i) #\p) (setf (nodgui:image (svref board i))
                                         (if (whitep row column)
                                             (nodgui:make-image "png/Chess_pdt60_white.gif")
                                             (nodgui:make-image "png/Chess_pdt60.gif"))))
          ((char= (elt pos i) #\R) (setf (nodgui:image (svref board i))
                                         (if (whitep row column)
                                             (nodgui:make-image "png/Chess_rlt60_white.gif")
                                             (nodgui:make-image "png/Chess_rlt60.gif"))))
          ((char= (elt pos i) #\N) (setf (nodgui:image (svref board i))
                                         (if (whitep row column)
                                             (nodgui:make-image "png/Chess_nlt60_white.gif")
                                             (nodgui:make-image "png/Chess_nlt60.gif"))))
          ((char= (elt pos i) #\B) (setf (nodgui:image (svref board i))
                                         (if (whitep row column)
                                             (nodgui:make-image "png/Chess_blt60_white.gif")
                                             (nodgui:make-image "png/Chess_blt60.gif"))))
          ((char= (elt pos i) #\Q) (setf (nodgui:image (svref board i))
                                         (if (whitep row column)
                                             (nodgui:make-image "png/Chess_qlt60_white.gif")
                                             (nodgui:make-image "png/Chess_qlt60.gif"))))
          ((char= (elt pos i) #\K) (setf (nodgui:image (svref board i))
                                         (if (whitep row column)
                                             (nodgui:make-image "png/Chess_klt60_white.gif")
                                             (nodgui:make-image "png/Chess_klt60.gif"))))
          ((char= (elt pos i) #\P) (setf (nodgui:image (svref board i))
                                         (if (whitep row column)
                                             (nodgui:make-image "png/Chess_plt60_white.gif")
                                             (nodgui:make-image "png/Chess_plt60.gif"))))
          (t (setf (nodgui:image (svref board i))
                   (if (whitep row column)
                       (nodgui:make-image "png/white60.gif")
                       (nodgui:make-image "png/empty60.gif")))))
